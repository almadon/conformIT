...
| | |
|---|---|
| [Rules of Engagement](rules-of-engagement.md) | How an AI agent works in a conforming repo |
| [Design principles](design-principles.md) | Structural defaults, each with its cost |
